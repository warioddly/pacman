...
import 'package:pacman/core/enums/enums.dart';
import 'package:pacman/core/extensions/extensions.dart';
import 'package:pacman/core/utils/util.dart';
...
class CollisionUtil {
  ...
  Direction getDirectionCollision(
    ...
    if (isCircle) {
      double angle = Util.angleBetweenPoints(c, point);
      return _directionsBlockedCache[key] = Util.getDirectionFromAngle(
        angle,
        directionSpace: 22.5,
      );
    }
